...
public class FireplaceMechanic : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(timeSinceCheck >= 2.5f && this.currentCapacity > 0.0f)
        {
            // Reset the timer.
            timeSinceCheck = 0;
            ...
            float yScale = capacityRatio * this.transform.localScale.y * 0.995f;
            ...
            float yPos = this.transform.position.y - 0.005f;
